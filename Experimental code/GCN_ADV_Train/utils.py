...
def load_data(dataset_str):
    ...
    # 修改后代码↓
    # Define indices for train, validation, and test sets (8:1:1 ratio)
    total_samples = labels.shape[0]
    train_size = int(total_samples * 0.8)
    val_size = int(total_samples * 0.1)

    # Define the training, validation, and testing indices
    idx_train = list(range(train_size))
    idx_val = list(range(train_size, train_size + val_size))
    idx_test = list(range(train_size + val_size, total_samples))
